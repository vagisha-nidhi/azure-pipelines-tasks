...
export const trafficSplitMethod: string = tl.getInput('trafficSplitMethod', false) || 'pod';
export const baselineAndCanaryReplicas: string = tl.getInput('baselineAndCanaryReplicas', false);
